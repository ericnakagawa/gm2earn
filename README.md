...
<details>
  ...
  <ol>
    <li>
      ...
      <a href="#eth-global-nyc">For ETH Global NYC hackers</a>
      <ul>
...
```
    // you may supply your own Alfajores private key here, or find one that's been autogenerated from packages/hardhat/account_keys.json
    export PRIVATE_KEY=####ALFAJORES TESTNET PRIVATE KEY#####
    // add a CELOSCAN_API_KEY to automatically verify your contracts upon deploy Celoscan is managed by Etherscan. You may sign up for a key here https://celoscan.io/login then navigate to https://celoscan.io/myapikey and generate a new key, copy that below
    export CELOSCAN_API_KEY=#####YOURAPIKEY######
    export NEXT_PUBLIC_WC_PROJECT_ID=#####YOUR WALLET CONNECT KEY######
```
